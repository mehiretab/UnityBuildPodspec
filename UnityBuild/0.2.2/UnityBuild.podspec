...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'UnityFramework/**/*.{a,c,cpp,h,swift,mm}', 'Data/**/*.{a,c,cpp,h,swift,mm}', 'Unity-iPhone/**/*.{a,c,cpp,h,swift,mm}', 'UnityData.xcassets/**/*.{a,c,cpp,h,swift,mm}', 'MainApp/**/*.{a,c,cpp,h,swift,mm}', 'Libraries/**/*.{a,c,cpp,h,swift,mm}', 'Classes/**/*.{a,c,cpp,h,swift,mm}', 'UnityBuild/**/*.{a,c,cpp,h,swift,mm}', '*.{a,c,cpp,h,swift,mm}'
